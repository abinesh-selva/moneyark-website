...
const BottomNav = ({ scrolled }) => {
  ...
  return (
    <nav className={`fixed bottom-6 sm:bottom-8 left-1/2 -translate-x-1/2 z-50 flex items-center gap-0.5 sm:gap-2 p-1 sm:p-1.5 max-w-[calc(100vw-1rem)] bg-black/40 backdrop-blur-2xl rounded-full border border-white/10 shadow-[0_20px_50px_rgba(240,160,145,0.12)] transition-all duration-500 ${scrolled ? 'translate-y-0 opacity-100 pointer-events-auto' : 'translate-y-24 opacity-0 pointer-events-none'}`}>
      <Link
        className={`flex items-center gap-1.5 sm:gap-2 rounded-full px-2.5 sm:px-5 py-2 transition-all duration-300 ${isActive('/') ? 'bg-primary-container text-zinc-950' : 'text-zinc-400 hover:text-primary-container'}`}
        to="/"
      >
      ...
      <Link
        className={`flex items-center gap-1.5 sm:gap-2 rounded-full px-2.5 sm:px-5 py-2 transition-all duration-300 ${isActive('/pricing') ? 'bg-primary-container text-zinc-950' : 'text-zinc-400 hover:text-primary-container'}`}
        to="/pricing"
      >
      ...
      <Link
        className={`flex items-center gap-1.5 sm:gap-2 rounded-full px-2.5 sm:px-5 py-2 transition-all duration-300 ${isActive('/privacy') ? 'bg-primary-container text-zinc-950' : 'text-zinc-400 hover:text-primary-container'}`}
        to="/privacy"
      >
