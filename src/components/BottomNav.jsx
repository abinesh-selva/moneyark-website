...
const BottomNav = ({ scrolled }) => {
  ...
  return (
    <nav className={`fixed bottom-8 left-1/2 -translate-x-1/2 z-50 flex items-center gap-2 p-1.5 bg-black/40 backdrop-blur-2xl rounded-full border border-white/10 shadow-[0_20px_50px_rgba(0,255,194,0.1)] transition-all duration-500 ${scrolled ? 'translate-y-0 opacity-100 pointer-events-auto' : 'translate-y-24 opacity-0 pointer-events-none'}`}>
      <Link 
        className={`flex items-center gap-2 rounded-full px-5 py-2 transition-all duration-300 ${isActive('/') ? 'bg-[#00FFC2] text-zinc-950' : 'text-zinc-400 hover:text-[#00FFC2]'}`} 
        to="/"
      >
      ...
      <Link 
        className={`flex items-center gap-2 rounded-full px-5 py-2 transition-all duration-300 ${isActive('/pricing') ? 'bg-[#00FFC2] text-zinc-950' : 'text-zinc-400 hover:text-[#00FFC2]'}`} 
        to="/pricing"
      >
      ...
      <Link 
        className={`flex items-center gap-2 rounded-full px-5 py-2 transition-all duration-300 ${isActive('/privacy') ? 'bg-[#00FFC2] text-zinc-950' : 'text-zinc-400 hover:text-[#00FFC2]'}`} 
        to="/privacy"
      >
